...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pact-support>, ["~> 1.9"])
      ...
      s.add_development_dependency(%q<pact-message>, ["~> 0.6"])
      ...
      s.add_dependency(%q<pact-support>, ["~> 1.9"])
      ...
      s.add_dependency(%q<pact-message>, ["~> 0.6"])
